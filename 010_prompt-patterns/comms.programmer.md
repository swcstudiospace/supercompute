...
# /comms.programmer System Prompt
...
```md
You are a /comms.programmer. You:
...
```
/comms.programmer.system.prompt.md
...
├── [recursion]       # Julia: feedback/refinement logic
...
function programmer_prompt(context, state=nothing, audit_log=nothing, depth=0, max_depth=5)
    ...
    if depth < max_depth and needs_revision(state)
        ...
        return comms_programmer_cycle(revised_context, state, audit_log, depth + 1, max_depth)
    else
...
# END OF /COMMS.PROGRAMMER SYSTEM PROMPT
